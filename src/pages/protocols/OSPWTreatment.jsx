...
const OSPWTreatment = () => {
    ...
    const handleShare = () => {
        if (navigator.share) {
            navigator.share({
                title: 'OSPW Treatment',
                text: 'Check out this OSPW treatment!',
    ...
    return (
        <>
            <SimpleNav prevLocation={"/analyze/protocols/ospw"}>Treatment</SimpleNav>
            <Typography variant="h5" sx={{ color: '#704798', fontWeight: "bold", textAlign: "center", paddingTop: 2 }}>OSPW</Typography>
            <Typography variant="body1" sx={{ fontWeight: "bold", textAlign: "center", paddingBottom: 2 }}>Oily, Sensitive, Pigmented, & Wrinkled</Typography>
            ...
            {value === 0 && <Box p={3}>
                <p><strong>ارتقای اول: مراقبت </strong><strong>&ndash;</strong><strong> هر سه هفته/یک ماه یک بار</strong></p>
                <p>C-Purity foam</p>
            ...
            {value === 1 && <Box p={3}>
                ...
                <p>عصاره Swertia Chirata: یک ماده ابتکاری است که از برگ های جنتیان هندی به دست می&zwnj;آید. برای کمک به جوانسازی و ضخیم شدن پوست فرموله شده است. مطالعات نشان داده است که می تواند چین و چروک های عمودی اطراف لب را کاهش دهد. این عصاره گیاهی به احیای پوست پیر و بهبود بافت و ظاهر اطراف ناحیه ظریف لب کمک می کند.</p>
                <p>هیالورونات سدیم: یک اسید هیالورونیک با خلوص بالا و وزن مولکولی بالا است که آبرسانی عمیقی به پوست می&zwnj;دهد. هیالورونات سدیم به دلیل خاصیت رطوبت&zwnj;گیری یا جذب آب قوی می تواند آب را در سطح پوست نگه دارد و به عنوان یک مخزن رطوبت عمل می&zwnj;کند. این به آن اجازه می&zwnj;دهد تا پوست را برای مدت طولانی&zwnj;تری هیدراته نگه دارد.</p>
                <p>⚠ Derma White را به عصرها پس از LumiLac اضافه کنید: Derma White را به آرامی اضافه کنید (یک روز در میان). زمانی که شرایط پوست مناسب شد هرروز عصر استفاده کنید.</p>
