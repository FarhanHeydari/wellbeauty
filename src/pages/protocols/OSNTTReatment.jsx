...
const OSNTTreatment = () => {
    ...
    const handleShare = () => {
        if (navigator.share) {
            navigator.share({
                title: 'OSNT Treatment',
                text: 'Check out this OSNT treatment!',
    ...
    return (
        <>
            <SimpleNav prevLocation={"/analyze/protocols/osnt"}>Treatment</SimpleNav>
            <Typography variant="h5" sx={{ color: '#704798', fontWeight: "bold", textAlign: "center", paddingTop: 2 }}>OSNT</Typography>
            <Typography variant="body1" sx={{ fontWeight: "bold", textAlign: "center", paddingBottom: 2 }}>Oily, Sensitive, Non-Pigmented, & Tight</Typography>
            ...
            {value === 0 && <Box p={3}>
                ...
                <h3>ترکیب PuriMask (3/2) + CoolRelief (3/1) &ndash; 15 دقیقه - شستشو</h3>
