...
const DSPTTreatment = () => {
    ...
    const handleShare = () => {
        if (navigator.share) {
            navigator.share({
                title: 'DSPT Treatment',
                text: 'Check out this DSPT treatment!',
    ...
    return (
        <>
            <SimpleNav prevLocation={"/analyze/protocols/dspt"}>Treatment</SimpleNav>
            <Typography variant="h5" sx={{ color: '#704798', fontWeight: "bold", textAlign: "center", paddingTop: 2 }}>DSPT</Typography>
            <Typography variant="body1" sx={{ fontWeight: "bold", textAlign: "center", paddingBottom: 2 }}>Dry, Sensitive, Pigmented, & Tight</Typography>
