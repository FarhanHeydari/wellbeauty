...
const DSNWTreatment = () => {
    ...
    const handleShare = () => {
        if (navigator.share) {
            navigator.share({
                title: 'DSNW Treatment',
                text: 'Check out this DSNW treatment!',
    ...
    return (
        <>
            <SimpleNav prevLocation={"/analyze/protocols/dsnw"}>Treatment</SimpleNav>
            <Typography variant="h5" sx={{ color: '#704798', fontWeight: "bold", textAlign: "center", paddingTop: 2 }}>DSNW</Typography>
            <Typography variant="body1" sx={{ fontWeight: "bold", textAlign: "center", paddingBottom: 2 }}>Dry, Sensitive, Non-Pigmented, & Wrinkled</Typography>
            ...
            {value === 0 && <Box p={3}>
                ...
                <h3>KeratPeel (لایه نازک) - شستشو ندهید.</h3>
                ...
                <h3>SalPeel 20: دو لایه &ndash; شستشو ندهید (فقط یک لایه برای Fitzpatrick 4-6)</h3>
                ...
                <p>آماده سازی پوست برای لایه برداری، پرکننده و لیزر درمانی. نرم کننده پیش لایه برداری برای آماده سازی پوست برای هر گونه درمان مانند لایه برداری، فیلر و لیزر استفاده می شود.</p>
                <p>با چربی زدایی پوست، پوست را برای درمان های لایه برداری آماده می کند و به پخش و نفوذ یکنواخت عوامل لایه بردار کمک می&zwnj;کند. نرم کننده پیش لایه برداری حاوی ماده ضد تحریک ShieldSkin است.</p>
                <p>PyPeel 20 نانو&ndash; 5-3 دقیقه (به مرور زمان اگر شرایط پوست اجازه دهد، زمان اعمال می&zwnj;تواند بیشتر شود.)</p>
                <p>ژل تیکسوتروپیک نانوساختار</p>
                <p>اسید پیروویک 40%</p>
                <p>به همراه ShieldSkin</p>
                <p>فقط برای استفاده حرفه ای در کلینیک</p>
